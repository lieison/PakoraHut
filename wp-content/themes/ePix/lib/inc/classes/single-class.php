 ...
 */ ?>
	...
	<div class="nextprevious_posts clearfix">
		<?php next_post_link('<span class="alignright">%link &rarr;</span>'); ?>
		<?php previous_post_link('<span class="alignleft">&larr; %link</span>'); ?>
	</div>
	...
	if ( get_the_author_meta( 'user_description' ) && $NV_authorname) :  ?>
