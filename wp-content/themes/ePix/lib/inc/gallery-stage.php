<?php 
	...
	echo '<div class="slider-inner-wrap '. ( !empty( $NV_galleryheight ) ? 'cap-height' : '' ) .'" '. ( !empty( $NV_galleryheight ) ? 'style="height:'. $NV_galleryheight .'px;"' : '' ) .'>';
