			...
			if( $NV_groupgridcontent != "text" )
			{
				...
				{ 					
					...
					{ 
						...
						$output .= '<a href="'. $lightbox_url .'" '. $lightbox_iframe .' data-fancybox-group="gallery'. $NV_shortcode_id .'" class="fancybox action-icons lightbox-icon '. $split .'"><i class="'. $lightbox_type .' fa-lg"></i></a>';
					}
