...
------------------------------------*/ 
	...
	if( $collapse_menu == 'collapse-menu' )
	{
		echo '<div class="collapse-menu-trigger-wrap skinset-header nv-skin"><div class="collapse-menu trigger"><i class="fa fa-bars fa-lg"></i></div></div>';
	}	
	...
	<header id="header-wrap" class="<?php echo $NV_frame_header .' '. $NV_autohide_menu . ' '. $collapse_menu .' ' . $fixed_header; ?> clearfix" <?php echo $auto_hide_menu_timeout; ?>>
		...
		{  ?>
			...
			<div class="dock-panel-wrap">
                        ...
                        <ul class="dock-tab-wrapper skinset-header nv-skin shop-cart">
                            <li>
                            	...
                            	<span class="shop-cart-icon">
                                	<a target="_parent" href="<?php echo $woocommerce->cart->get_cart_url(); ?>"><i class="fa fa-shopping-cart fa-lg"></i></a>
                            	</span>
                            </li>
                        </ul>
                    </li>
				...
				if( of_get_option('enable_responsive') )			
				{ ?>
