<?php 
	...
	{
		wp_register_style( 'woocommerce', get_template_directory_uri() . '/stylesheets/woocommerce.css', false, null );
	...
	{ 
		...
		if( !empty($link_color_settings) )
		{
			...
			.skinset-'.$element.$z.' #content .cart-collaterals .cart_totals .total,
			.skinset-'.$element.$z.' #content .cart-collaterals .cart_totals .cart-subtotal,
			.skinset-'.$element.$z.' #content .cart-collaterals .cart_totals span.amount,
			.skinset-'.$element.$z.' #content .summary span.amount,
		...
		if( !empty($elem_bgcolor_settings) )
		{
			...
			.skinset-'.$element.$z.' .post.sticky .post-titles:before { '. $elem_bgcolor_settings .' }
			';	
		}
		...
		if( !empty($elemhover_bgcolor_settings) )
		{
			...
			.skinset-'.$element.$z.' button.button:hover  { '.$elemhover_bgcolor_settings.' }
			';	
		}
		...
		if( !empty( $shaded_background_color ) )
		{
			...
			.skinset-'.$element.$z.' div.wp-caption { '. $shaded_background_color .' }
			';
		}
		...
		if( !empty( $outer_border_color ) )
		{
			...
			.skinset-'.$element.$z.'.collapse-menu-trigger-wrap { '. $outer_border_color .' }
			';			
		}
