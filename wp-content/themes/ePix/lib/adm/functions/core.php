<?php
	...
	function tva_ajaxdata()
	{
	   $data_contents = $data_source = $type = '';
		...
		$load_value 	= $_POST['load_value'];
		$postlayout 	= $_POST['postlayout'];
		$grid_columns 	= $_POST['grid_columns'];
		$config 		= $_POST['attributes'];
		...
		$NV_groupgridcontent 	= $config_attributes['content'];	
		$NV_imgwidth 			= $config_attributes['img_width'];	
		$NV_imgheight			= $config_attributes['img_height'];			
		$NV_lightbox 			= $config_attributes['lightbox'];	
		$NV_imageeffect 		= $config_attributes['imageeffect'];	
		$NV_customlayer 		= $config_attributes['customlayer'];		
		$NV_zoomhover			= $config_attributes['zoomhover'];	
		$NV_gridcolumns_text	= $NV_slidercolumns_text = numberToWords( $NV_gridcolumns );	
		$columnpadding 		= $config_attributes['columnpadding'];
		$NV_shortcode_id		= $config_attributes['shortcodeid'];
		$NV_blackwhite			= '';
