			...
			<div id="footer" class="clearfix skinset-footer row nv-skin <?php echo $NV_frame_footer; ?>">
				<div class="row content">
					...
					if( of_get_option('lowerfooter')!="disable" )
					{
						...
						$lower_right = ( of_get_option('lowfooterright') !='' ) ? of_get_option('lowfooterright') : 'Powered by <a href="http://epix.themeva.com" title="ePix WordPress Photography Theme" target="_blank">ePix</a>';
